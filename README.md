# MultiArchiver (web extension for Firefox) [WORK IN PROGRESS]

MultiArchiver is a extension that lets you save a webpage to multiple archival services ([archive.org](https://archive.org/), [archive.today](https://archive.today) and [Ghost Archive](https://ghostarchive.org)). It also lets you check if the page has already been archived.
...
2. Use the MultiArchiver menu to *save* or *check* your selected item.
